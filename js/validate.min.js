...
(()=>{
    var i = {
            ...
            i.exports = function(i) {
                ...
                return t.toString = function() {
                    return this.map((function(t) {
                        ...
                        e && (n += "@layer".concat(t[5].length > 0 ? " ".concat(t[5]) : "", " {")),
                        n += i(t),
                        e && (n += "}"),
                        t[2] && (n += "}"),
                        t[4] && (n += "}"),
                ...
                ,
                t.i = function(i, n, e, o, a) {
                    "string" == typeof i && (i = [[null, i, void 0]]);
                    var s = {};
                    if (e)
                    ...
                    for (var p = 0; p < i.length; p++) {
                        var h = [].concat(i[p]);
                        e && s[h[0]] || (void 0 !== a && (void 0 === h[5] || (h[1] = "@layer".concat(h[5].length > 0 ? " ".concat(h[5]) : "", " {").concat(h[1], "}")),
                        h[5] = a),
                        n && (h[2] ? (h[1] = "@media ".concat(h[2], " {").concat(h[1], "}"),
                        h[2] = n) : h[2] = n),
                        o && (h[4] ? (h[1] = "@supports (".concat(h[4], ") {").concat(h[1], "}"),
                        h[4] = o) : h[4] = "".concat(o)),
                        t.push(h))
                    }
                }
        ...
        197: i=>{
            ...
            t = function(i) {
                ...
                return function() {
                    ...
                    var s = 0
                      ...
                      , p = function(i, t) {
                        for (var n = Object.keys(i), e = 0; e < n.length; e++)
                            t(n[e], i[n[e]])
                    }
                      , h = function(i) {
                      ...
                      , u = function() {
                        function n(i, t) {
                            ...
                            this.options = {},
                            p(r, (function(i, t) {
                                e.options[i] = o.hasOwnProperty(i) ? o[i] : t
                            }
                            )),
                            this.hadInitialPlaceholder = Boolean(i.getAttribute("placeholder"))
                        }
                        var e, a;
                        return e = n,
                        a = [{
                            ...
                            value: function() {
                                ...
                                "undefined" != typeof Promise) {
                                    var t = new Promise((function(t, n) {
                                        ...
                                        i.rejectAutoCountryPromise = n
                                    }
                                    ))
                                      , n = new Promise((function(t, n) {
                                        i.resolveUtilsScriptPromise = t,
                                        i.rejectUtilsScriptPromise = n
                                    }
                                    ));
                            ...
                            value: function() {
                                if (this.options.onlyCountries.length) {
                                    var i = this.options.onlyCountries.map((function(i) {
                                    ...
                                    var n = this.options.excludeCountries.map((function(i) {
                                        return i.toLowerCase()
                                    }
                                    ));
                                    this.countries = t.filter((function(i) {
                                        return -1 === n.indexOf(i.iso2)
                                    }
                                    ))
                                } else
                                    this.countries = t
                            ...
                            value: function() {
                                for (var i = 0; i < this.countries.length; i++) {
                                    var t = this.countries[i].iso2.toLowerCase();
                                    this.options.localizedCountries.hasOwnProperty(t) && (this.countries[i].name = this.options.localizedCountries[t])
                                }
                            }
                        }, {
                            key: "_countryNameSort",
                            value: function(i, t) {
                                return i.name.localeCompare(t.name)
                            }
                        }, {
                            ...
                            value: function() {
                                ...
                                for (var n = 0; n < this.countries.length; n++) {
                                    var e = this.countries[n];
                                    if (e.areaCodes)
                                        for (var o = this.countryCodes[e.dialCode][0], a = 0; a < e.areaCodes.length; a++) {
                                            for (var s = e.areaCodes[a], r = 1; r < s.length; r++) {
                                                var l = e.dialCode + s.substr(0, r);
                                                this._addCountryCode(o, l),
                                                this._addCountryCode(e.iso2, l)
                                            }
                                            this._addCountryCode(e.iso2, e.dialCode + s)
                                        }
                                }
                            }
                        }, {
                            ...
                            value: function() {
                                ...
                                for (var i = 0; i < this.options.preferredCountries.length; i++) {
                                    var t = this.options.preferredCountries[i].toLowerCase()
                            ...
                            value: function() {
                                ...
                                var i = "iti";
                                this.options.allowDropdown && (i += " iti--allow-dropdown"),
                                this.options.separateDialCode && (i += " iti--separate-dial-code"),
                                this.options.customContainer && (i += " ",
                                i += this.options.customContainer);
                                ...
                                this.options.hiddenInput) {
                                    ...
                                    if (e) {
                                        var o = e.lastIndexOf("[");
                                        -1 !== o && (n = "".concat(e.substr(0, o), "[").concat(n, "]"))
                                    }
                            ...
                            value: function(i, t, n) {
                                for (var e = "", o = 0; o < i.length; o++) {
                                    var a = i[o]
                                      , s = n ? "-preferred" : "";
                                    e += "<li class='iti__country ".concat(t, "' tabIndex='-1' id='iti-").concat(this.id, "__item-").concat(a.iso2).concat(s, "' role='option' data-dial-code='").concat(a.dialCode, "' data-country-code='").concat(a.iso2, "' aria-selected='false'>"),
                                    e += "<div class='iti__flag-box'><div class='iti__flag iti__".concat(a.iso2, "'></div></div>"),
                                    e += "<span class='iti__country-name'>".concat(a.name, "</span>"),
                                    e += "<span class='iti__dial-code'>+".concat(a.dialCode, "</span>"),
                                    e += "</li>"
                                }
                            ...
                            value: function() {
                                var i = this.telInput.getAttribute("value")
                                  , t = this.telInput.value
                                  , n = !i || "+" !== i.charAt(0) || t && "+" === t.charAt(0) ? t : i
                                  , e = this._getDialCode(n)
                                  , o = this._isRegionlessNanp(n)
                                  , a = this.options
                                  , s = a.initialCountry
                                  , r = a.nationalMode
                                  , l = a.autoHideDialCode
                                  , p = a.separateDialCode;
                                e && !o ? this._updateFlagFromNumber(n) : "auto" !== s && (s ? this._setFlag(s.toLowerCase()) : e && o ? this._setFlag("us") : (this.defaultCountry = this.preferredCountries.length ? this.preferredCountries[0].iso2 : this.countries[0].iso2,
                                n || this._setFlag(this.defaultCountry)),
                                n || r || l || p || (this.telInput.value = "+".concat(this.selectedCountryData.dialCode))),
                            ...
                            value: function() {
                                ...
                                this._handleHiddenInputSubmit = function() {
                                    i.hiddenInput.value = i.getNumber()
                                }
                                ,
                            ...
                            value: function() {
                                for (var i = this.telInput; i && "LABEL" !== i.tagName; )
                                    i = i.parentNode;
                                return i
                            }
                        }, {
                            ...
                            value: function() {
                                ...
                                this._handleLabelClick = function(t) {
                                    i.countryList.classList.contains("iti__hide") ? i.telInput.focus() : t.preventDefault()
                                }
                                ;
                                var t = this._getClosestLabel();
                                t && t.addEventListener("click", this._handleLabelClick),
                                this._handleClickSelectedFlag = function() {
                                    !i.countryList.classList.contains("iti__hide") || i.telInput.disabled || i.telInput.readOnly || i._showDropdown()
                                }
                                ,
                                this.selectedFlag.addEventListener("click", this._handleClickSelectedFlag),
                                this._handleFlagsContainerKeydown = function(t) {
                                    i.countryList.classList.contains("iti__hide") && -1 !== ["ArrowUp", "Up", "ArrowDown", "Down", " ", "Enter"].indexOf(t.key) && (t.preventDefault(),
                                    t.stopPropagation(),
                                    i._showDropdown()),
                                    "Tab" === t.key && i._closeDropdown()
                                }
                                ,
                            ...
                            value: function() {
                                ...
                                "function" == typeof this.options.geoIpLookup && this.options.geoIpLookup((function(i) {
                                    window.intlTelInputGlobals.autoCountry = i.toLowerCase(),
                                    setTimeout((function() {
                            ...
                            value: function() {
                                ...
                                this._handleClipboardEvent = function() {
                                    setTimeout(i._handleKeyupEvent)
                                }
                                ,
                            ...
                            value: function() {
                                ...
                                !this.isMobile) {
                                    var t = this.telInput.getBoundingClientRect()
                                      ...
                                      , a = e + this.telInput.offsetHeight + o < n + window.innerHeight
                                      , s = e - o > n;
                                    if (this._toggleClass(this.countryList, "iti__country-list--dropup", !a && s),
                                    this.options.dropdownContainer) {
                                        var r = !a && s ? 0 : this.telInput.offsetHeight;
                                        this.dropdown.style.top = "".concat(e + r, "px"),
                            ...
                            value: function(i) {
                                for (var t = i; t && t !== this.countryList && !t.classList.contains("iti__country"); )
                                    t = t.parentNode;
                            ...
                            value: function() {
                                ...
                                this._handleMouseoverCountryList = function(t) {
                                    var n = i._getClosestListItem(t.target);
                                    n && i._highlightListItem(n, !1)
                                }
                                ,
                                this.countryList.addEventListener("mouseover", this._handleMouseoverCountryList),
                                this._handleClickCountryList = function(t) {
                                    var n = i._getClosestListItem(t.target);
                                    n && i._selectListItem(n)
                                }
                                ,
                                ...
                                this._handleKeydownOnDropdown = function(t) {
                                    t.preventDefault(),
                                    "ArrowUp" === t.key || "Up" === t.key || "ArrowDown" === t.key || "Down" === t.key ? i._handleUpDownKey(t.key) : "Enter" === t.key ? i._handleEnterKey() : "Escape" === t.key ? i._closeDropdown() : /^[a-zA-ZÀ-ÿа-яА-Я ]$/.test(t.key) && (e && clearTimeout(e),
                                    n += t.key.toLowerCase(),
                            ...
                            value: function(i) {
                                var t = "ArrowUp" === i || "Up" === i ? this.highlightedItem.previousElementSibling : this.highlightedItem.nextElementSibling;
                                t && (t.classList.contains("iti__divider") && (t = "ArrowUp" === i || "Up" === i ? t.previousElementSibling : t.nextElementSibling),
                            ...
                            value: function(i) {
                                for (var t = 0; t < this.countries.length; t++)
                                    if (this._startsWith(this.countries[t].name, i)) {
                            ...
                            key: "_startsWith",
                            value: function(i, t) {
                                return i.substr(0, t.length).toLowerCase() === t
                            }
                        }, {
                            ...
                            value: function(i) {
                                var t = i
                                  ...
                                  , e = "1" === n;
                                t && this.options.nationalMode && e && "+" !== t.charAt(0) && ("1" !== t.charAt(0) && (t = "1".concat(t)),
                                t = "+".concat(t)),
                                ...
                                if (o) {
                                    var r = this.countryCodes[this._getNumeric(o)]
                                      , l = -1 !== r.indexOf(this.selectedCountryData.iso2) && a.length <= o.length - 1;
                                    ...
                                    "+" === t.charAt(0) && a.length ? s = "" : t && "+" !== t || (s = this.defaultCountry);
                                return null !== s && this._setFlag(s)
                            }
                        }, {
                            key: "_isRegionlessNanp",
                            value: function(i) {
                                var t = this._getNumeric(i);
                                if ("1" === t.charAt(0)) {
                                    var n = t.substr(1, 3);
                            ...
                            value: function(i) {
                                ...
                                this.selectedCountryData = i ? this._getCountryData(i, !1, !1) : {},
                                this.selectedCountryData.iso2 && (this.defaultCountry = this.selectedCountryData.iso2),
                                this.selectedFlagInner.setAttribute("class", "iti__flag iti__".concat(i));
                                var n = i ? "".concat(this.selectedCountryData.name, ": +").concat(this.selectedCountryData.dialCode) : "Unknown";
                                if (this.selectedFlag.setAttribute("title", n),
                                this.options.separateDialCode) {
                                    var e = this.selectedCountryData.dialCode ? "+".concat(this.selectedCountryData.dialCode) : "";
                                ...
                                this.options.allowDropdown) {
                                    ...
                                    if (a && (a.classList.remove("iti__active"),
                                    a.setAttribute("aria-selected", "false")),
                                    i) {
                                        var s = this.countryList.querySelector("#iti-".concat(this.id, "__item-").concat(i, "-preferred")) || this.countryList.querySelector("#iti-".concat(this.id, "__item-").concat(i));
                                        s.setAttribute("aria-selected", "true"),
                                        s.classList.add("iti__active"),
                                        this.activeItem = s,
                                        this.selectedFlag.setAttribute("aria-activedescendant", s.getAttribute("id"))
                                    }
                                }
                                return t.iso2 !== i
                            }
                            ...
                            value: function() {
                                var i = "aggressive" === this.options.autoPlaceholder || !this.hadInitialPlaceholder && "polite" === this.options.autoPlaceholder;
                                if (window.intlTelInputUtils && i) {
                            ...
                            key: "_selectListItem",
                            value: function(i) {
                                var t = this._setFlag(i.getAttribute("data-country-code"));
                                this._closeDropdown(),
                                this._updateDialCode(i.getAttribute("data-dial-code"), !0),
                                this.telInput.focus();
                            ...
                            value: function(i, t) {
                                var n = this.countryList
                                  ...
                                  , o = n.offsetHeight
                                  , a = n.getBoundingClientRect().top + e
                                  , s = a + o
                                  , r = i.offsetHeight
                                  , l = i.getBoundingClientRect().top + e
                                  , p = l + r
                                  , h = l - a + n.scrollTop
                                  , u = o / 2 - r / 2;
                                if (l < a)
                            ...
                            key: "_updateDialCode",
                            value: function(i, t) {
                                var n, e = this.telInput.value, o = "+".concat(i);
                                if ("+" === e.charAt(0)) {
                                ...
                                if ("+" === i.charAt(0))
                                    for (var e = "", o = 0; o < i.length; o++) {
                                        ...
                                        if (!isNaN(parseInt(a, 10))) {
                                            if (e += a,
                                            t)
                                                this.countryCodes[e] && (n = i.substr(0, o + 1));
                                            else if (this.dialCodes[e]) {
                                                n = i.substr(0, o + 1);
                                                break
                                            }
                                            if (e.length === this.countryCodeMaxLen)
                                                break
                                        }
                                    }
                                return n
                            ...
                            key: "_getFullNumber",
                            value: function() {
                                var i = this.telInput.value.trim()
                                  , t = this.selectedCountryData.dialCode
                                  , n = this._getNumeric(i);
                                return (this.options.separateDialCode && "+" !== i.charAt(0) && t && n ? "+".concat(t) : "") + i
                            }
                        }, {
                            ...
                            value: function(i) {
                                ...
                                if (this.options.separateDialCode) {
                                    ...
                                    if (n) {
                                        var e = " " === t[(n = "+".concat(this.selectedCountryData.dialCode)).length] || "-" === t[n.length] ? n.length + 1 : n.length;
                                        t = t.substr(e)
                                    }
                                }
                                return this._cap(t)
                            ...
                            value: function(i) {
                                if (window.intlTelInputUtils) {
                                    ...
                                    return intlTelInputUtils.formatNumber(this._getFullNumber(), t, i)
                                }
                                return ""
                            }
                        }, {
                            ...
                            key: "isValidNumber",
                            value: function() {
                                var i = this._getFullNumber().trim()
                                  , t = this.options.nationalMode ? this.selectedCountryData.iso2 : "";
                                return window.intlTelInputUtils ? intlTelInputUtils.isValidNumber(i, t) : null
                            }
                        }, {
                            key: "setCountry",
                            value: function(i) {
                            ...
                            key: "setNumber",
                            value: function(i) {
                                var t = this._updateFlagFromNumber(i);
                            ...
                            value: function(i) {
                                this.options.placeholderNumberType = i,
                                this._updatePlaceholder()
                            }
                        }],
                        a && o(e.prototype, a),
                    ...
                    function(i, t) {
                        var n = new u(i,t);
                        return n._init(),
                        i.setAttribute("data-intl-tel-input-id", n.id),
            ...
            ,
            i.exports ? i.exports = t() : window.intlTelInput = t()
        }
        ,
        699: (i,t,n)=>{
            i.exports = n(197)
        ...
        379: i=>{
            ...
            function o(i, t) {
                ...
                function(t) {
                    if (t) {
                        if (t.css === i.css && t.media === i.media && t.sourceMap === i.sourceMap && t.supports === i.supports && t.layer === i.layer)
                            return;
                        n.update(i = t)
                    } else
                        n.remove()
            ...
            i.exports = function(i, o) {
                ...
                return function(i) {
                    ...
                    for (var l = e(i, o), p = 0; p < a.length; p++) {
                        var h = n(a[p]);
        ...
        216: i=>{
            ...
            i.exports = function(i) {
                ...
                return i.setAttributes(t, i.attributes),
                i.insert(t, i.options),
                t
            }
        }
        ,
        ...
        795: i=>{
            "use strict";
            i.exports = function(i) {
                var t = i.insertStyleElement(i);
                return {
                    update: function(n) {
                        !function(i, t, n) {
                            var e = "";
                            n.supports && (e += "@supports (".concat(n.supports, ") {")),
                            n.media && (e += "@media ".concat(n.media, " {"));
                            var o = void 0 !== n.layer;
                            o && (e += "@layer".concat(n.layer.length > 0 ? " ".concat(n.layer) : "", " {")),
                            e += n.css,
                            o && (e += "}"),
                            n.media && (e += "}"),
                            n.supports && (e += "}");
                            ...
                            t.styleTagTransform(e, i, t.options)
                        }(t, i, n)
                    },
                    remove: function() {
                        !function(i) {
    ...
    n.d = (i,t)=>{
        for (var e in t)
            n.o(t, e) && !n.o(i, e) && Object.defineProperty(i, e, {
                enumerable: !0,
                get: t[e]
            })
    }
    ,
    n.o = (i,t)=>Object.prototype.hasOwnProperty.call(i, t),
    n.nc = void 0,
    (()=>{
        "use strict";
        const i = jQuery;
        ...
        var o, a = function(i) {
            this.popup = t()(i.popupRender.replace("{privacy}", i.privacy)).appendTo("body"),
            this.overlay = t()(i.overlayRender).appendTo("body"),
            this.checkbox = null;
            var n = this;
            this.popup.find(".confirm").click((function() {
                n.checkbox.prop("checked", !0),
                n.checkbox.change(),
                n.hide()
            }
            ))
        ...
        class l {
            constructor(i, n, e) {
                ...
                this.value = null,
                this.oldValue = "",
                this.rules && (this.erElem = null,
                this.tipElem = null,
                this.required = -1 !== n.indexOf("required")),
                this.$placeholder = null,
                t()(this.elem).siblings("label").length && (this.$placeholder = t()(this.elem).siblings("label"));
                var o = !0;
                ...
                var a = this;
                this.rules && (i.on("change completed", (function() {
                    a._validate()
                }
                )),
                this.opts.validateOnBlur && i.on("blur", (function() {
                    a._validate()
                }
                )),
                i.on("input keypress keydown paste", (function() {
                    a._validate(!0)
                }
                ))),
                n && ~n.indexOf("alpha") && (i.on("input", (function() {
                    a._testInput()
                }
                )),
                ...
                n && ~n.indexOf("valid_phone") && (a._transformToPhone(),
                i.on("input", (function() {
                    a._transformToPhone()
                }
                ))),
                n && ~n.indexOf("valid_international") && (a.iti = r()(i[0], {
                    nationalMode: !1,
                    formatOnDisplay: !0,
                    preferredCountries: [],
                    initialCountry: "auto",
                    geoIpLookup: function(i) {
                        t().get("https://ipinfo.io", (function() {}
                            ...
                            const n = t?.country ? t.country : "ru";
                            i(n)
                        }
                        ))
                    },
                ...
                this._validate(!0),
                this.$placeholder && (a._placeholder(),
                i.on("focusin input", (function() {
            ...
            _validate(i) {
                ...
                !this.rules)
                    return !0;
                if ("stopvalidation" === this.elem.attr("data-validation"))
                    return this.valid = !0,
                    this.value = null,
                    this._removeError(),
                    !0;
                if (!i || this.value !== ("file" === this.elem[0].type ? this.elem[0].files : this.elem.val())) {
                    var t, n, e = this.rules.split("|"), o = !this.elem.val(), a = [];
                    for (this.value = "file" === this.elem[0].type ? this.elem[0].files : this.elem.val(),
                    t = 0,
                    n = e.length; t < n; t++) {
                        var s = e[t]
                          , r = null
                          , l = !1
                          , p = this.opts.ruleRegex.exec(s);
                        if (o && !this.required)
                            break;
                        if ((!o || -1 !== ["required", "agreement"].indexOf(s)) && (p && (s = p[1],
                        r = p[2]),
                        "!" === s.charAt(0) && (s = s.substring(1, s.length)),
                        "function" == typeof this._hooks[s] && (this._hooks[s].apply(this, [r]) || (l = !0)),
                        l)) {
                            var h = this.elem.data(s);
                            h || (h = this.opts.messages[s]),
                            r && (h = h.replace("%s", r)),
                            a.push(h)
                        }
                    }
                    return a.length ? (i || this._setError(a),
                    this.valid = !1,
                    this.elem.attr("data-validation", "invalid")) : (this._removeError(),
                    this.valid = !0,
            ...
            _testInput() {
                "stopvalidation" !== this.elem.attr("data-validation") ? (this.value = this.elem.val(),
                this._hooks.alpha.apply(this) ? (this.oldValue = this.value,
                this._tip(!0)) : (this.elem.val(this.oldValue),
                this._tip())) : this._tip(!0)
            }
            _tip(i) {
                i = i || !1;
                var n = this.opts.messages.alpha;
                i ? this.tipElem && (this.tipElem.remove(),
                this.tipElem = null) : this.tipElem || (this.tipElem = t()('<span class="message-tooltip">' + n + "</span>").insertAfter(this.elem))
            }
            _transformToPhone() {
                let i = this.elem.val();
                if (!i)
                ...
                if (i = i.replace(/\D/g, ""),
                !i.length)
                    return void this.elem.val("");
                const t = function(i, t) {
                    const n = i.replace(/\D/g, "");
                    t.length >= n.length && n === t.slice(0, n.length) && (t = t.slice(n.length));
                    let e = "" + t
                      , o = "";
                    for (let t = 0, n = 0; t < i.length && n < e.length; t++)
                        o += "X" === i.charAt(t) ? e.charAt(n++) : i.charAt(t);
                    return o
                }(this.opts.phoneRegex.source.replaceAll("\\", "").replace("^", "").replace("$", "").replace(/d{(\d+)}/g, (function(i, t) {
                    return "X".repeat(+t)
                }
                )), i);
                this.elem.val(t),
            ...
            _transformToInternational() {
                if ("undefined" != typeof intlTelInputUtils) {
                    var i = this.iti.getNumber(intlTelInputUtils.numberFormat.E164);
                    "string" == typeof i && this.iti.setNumber(i)
                }
                this._validate(!0)
            }
            _placeholder(i) {
                var t = !this.elem.val();
                i = i || "focusout",
                this.opts.hideLabels && ("focusout" === i && t ? this.$placeholder.removeClass("label-none") : this.$placeholder.addClass("label-none"))
            }
            _setError(i) {
                this.erElem ? this.erElem.html(i.join(" ")) : -1 === this.rules.indexOf("agreement") && (this.erElem = t()('<span class="message-error">' + i.join(" ") + "</span>").insertAfter(this.elem)),
                this.elem.addClass("error"),
                this.elem.removeClass("correctly")
            }
            _removeError() {
                this.erElem && (this.erElem.remove(),
                this.erElem = null,
            ...
            _hooks = {
                required: function() {
                    var i = this.elem[0].type;
                    return "checkbox" === i || "radio" === i ? !0 === this.elem[0].checked : !!this.value
                },
                ...
                min_length: function(i) {
                    return !!this.opts.numericRegex.test(i) && this.value.length >= parseInt(i, 10)
                },
                alpha: function() {
                    return this.opts.alphaRegex.test(this.value)
                },
                agreement: function() {
                    var i, t = this.elem[0].type;
                    if ("checkbox" === t || "radio" === t) {
                        var n = !0 === this.elem[0].checked;
                        return n || (i = this.opts,
                        o || (o = new a(i)),
                        o).show(this.elem),
                        n
                    }
                ...
                extension: function() {
                    ...
                    if (!this.elem.data("validationExt"))
                        return !0;
                    i = this.elem.data("validationExt").split(",").map((function(i) {
                        return i.trim()
                    }
                    ));
                    for (let t = 0; t < this.value.length; t++) {
                        let n = this.value[t].name.slice(this.value[t].name.lastIndexOf(".") + 1);
                        if (!~i.indexOf(n))
                            return !1
                    }
                    return !0
                ...
                max_size: function() {
                    let i;
                    if (console.log(this.value),
                    !this.elem.data("validationMaxSizeMb"))
                        return !0;
                    if (i = parseFloat(this.elem.data("validationMaxSizeMb")),
                    isNaN(i) || !isFinite(i))
                        return !0;
                    i = 1024 * i * 1024;
                    let t = 0;
                    for (let n = 0; n < this.value.length; n++)
                        if (t += this.value[n].size,
                        console.log(t),
                        t > i)
                            return !1;
                    return !0
        ...
        function() {
            if (t()("label.agreement-label .check").click((function(i) {
                i.preventDefault();
                var n = t()(this).siblings("input")
                  , e = !n.prop("checked");
                n.prop("checked", e),
                n.change()
            }
            ...
            t().fancybox) {
                var i = t().fancybox.defaults.clickContent;
                t().fancybox.defaults.clickContent = function(t, n) {
                    t.$content[0].contains(document.activeElement) && document.activeElement.blur(),
                    i(t, n)
                }
            }
        }(),
        t().fn.validate = function(i) {
            if (this.length)
                return i = t().extend(!0, {}, e, i),
                this.each((function() {
                    var n = t()(this).data("validator");
                    n || (t()(this).find("span.add-textarea").on("click", (function() {
                    ...
                    n = new class {
                        constructor(i, n) {
                            this.form = i,
                            this.allRules = n.rules,
                            this.opts = n,
                            this.buttons = [],
                            this.fields = [];
                            for (var e = 0; e < i.elements.length; e++)
                                if ("submit" !== i.elements[e].type) {
                                    var o = t()(i.elements[e])
                                      , a = this._genElemRules(o);
                                    a.length ? this.fields.push(new p(o,a.join("|"),this)) : this.fields.push(new p(o,null,this))
                                } else
                                    this.buttons.push(i.elements[e]);
                            this._checkButtons(),
                            t()(i).submit(t().proxy(this, "_validateForm"))
                        }
                        _genElemRules(i) {
                            for (var t = {}, n = [], e = 0; e < this.allRules.length; e++)
                                i.is(this.allRules[e].el) && (t[this.allRules[e].rule] = !0);
                            for (var o in t)
                                n.push(o);
                            return n
                        }
                        _validateForm(i) {
                            for (var t = !1, n = 0; n < this.fields.length; n++)
                                this.fields[n]._validate() || (t = !0);
                            return t && (i && i.preventDefault ? i.preventDefault() : i && (i.returnValue = !1),
                            i.stopImmediatePropagation()),
                            !0
                        }
                        _checkButtons() {
                            for (var i = !1, t = 0; t < this.fields.length; t++)
                                this.fields[t].valid || (i = !0);
                            if (i)
                                for (t = 0; t < this.buttons.length; t++)
                                    this.buttons[t].classList.add("disabled");
                            else
                                for (t = 0; t < this.buttons.length; t++)
                                    this.buttons[t].classList.remove("disabled")
                        }
                    }
                    (this,i),
                    t()(this).data("validator", n))
                }
                )),
                this
        }
